...
let StocksController = class StocksController {
    ...
    byChambre(id) { return this.service.findByChambre(+id); }
...
], StocksController.prototype, "byChambre", null);
__decorate([
    (0, common_1.Get)('unite/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], StocksController.prototype, "byUnite", null);
__decorate([
    (0, common_1.Post)(),
